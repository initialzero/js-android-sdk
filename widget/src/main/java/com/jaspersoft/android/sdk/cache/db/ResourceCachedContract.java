...
class ResourceCachedContract {
    public static final String SQL_CREATE_ACCOUNTS_TABLE =
            "CREATE TABLE " + CacheResourcesEntry.TABLE_NAME + " (" +
                    CacheResourcesEntry.COLUMN_ACCOUNT_ID + " INTEGER NOT NULL, " +
                    ...
                    "FOREIGN KEY (" + CacheResourcesEntry.COLUMN_ACCOUNT_ID + ") REFERENCES " + AccountsContract.AccountEntry.TABLE_NAME + "(" + AccountsContract.AccountEntry._ID + ") ON DELETE CASCADE" +
                    " )";
